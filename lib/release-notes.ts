...
export const RELEASE_NOTES: ReleaseNote[] = [
  {
    ...
    sha: 'b0c1755',
    changes: [
      'Your lender pack adds up \u2014 the kilograms and rand under the table now match the total above it',
      'Avocado and Avocados are one tree again, not a grower beside a seller',
      'The gardener panel your funder opens names your real crop, with the right picture',
      'Malabar spinach and pigeon peas stay in the orchard instead of landing on a vegetable bed',
