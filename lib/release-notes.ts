...
export const RELEASE_NOTES: ReleaseNote[] = [
  { when: '25 September 2026', sha: '3650b5d9', changes: [
    'The detailed site survey now pairs draft isiZulu with English for saving, roof water and production checks.',
    'The crop planner has isiZulu navigation and a clear note on farming guidance still shown in English.',
    'Records and invoices show more isiZulu controls, with English beside sensitive money and sync guidance.',
  ...
  { when: '24 September 2026', sha: 'e282a368', changes: [
    ...
    { title: 'Check farmer language', where: 'Farmer map and site report', href: '/farmer',
      detail: 'Choose isiZulu, open Add to my map, then view the site progress card.' },
  ] },
  ...
  { when: '22 September 2026', sha: '8eba11cf', changes: [
    ...
    { title: 'See the garden', where: 'Home → Take a tour', href: '/home',
      detail: 'Scroll below the shortcuts to see the larger garden photo and open the tour.' },
  ] },
  ...
  { when: '22 September 2026', sha: '17747f7', changes: [
    ...
    'App guides include sample screens to follow while you practise.',
  ], tour: [
    ...
    { title: 'Practise making an invoice', where: 'Studies → Using ImbewuField → Make and manage an invoice',
      href: '/student/guides/invoices',
      detail: 'Follow the sample screens and check the saved invoice before sharing it.' },
  ] },
  ...
  { when: '21 September 2026', sha: 'ec56c4e', changes: [
    ...
    { title: 'Offline learning pathways', where: 'Studies → Design or Farm Finance',
      href: '/student',
      detail: 'Open a pathway, save it, and check its pages before leaving signal.' },
  ] },
  ...
  { when: '21 September 2026', sha: 'e9c92821', changes: [
    'Studies now explains how to connect site evidence, test results and saved reports.',
    'Practise checking source labels, report dates and exported copies before sharing.',
  ] },
  { when: '21 September 2026', sha: '0fb0f893', changes: [
    'Studies now guides you through exporting records and checking the evidence behind them.',
    'The phone CSV button now says it exports this month; chart periods are separate.',
  ] },
  { when: '21 September 2026', sha: '57d0419b', changes: [
    'Studies now guides you through past paper sales and checking invoice payments.',
    'Paid invoice copies say Invoice total instead of asking for that amount again.',
  ] },
  ...
  { when: '20 September 2026', sha: 'd28077d', changes: [
    ...
    'iPad reports have more reading room, and survey Save stays visible with larger text.',
  ] },
  ...
  { when: '6 September 2026', sha: '9df6298', changes: [
    ...
    'Start with garden pictures, try an editable plan, and reach every Records header control.',
    'Detailed report photos now compress to fit, so the sample PDF can finish.',
  ] },
  ...
  { when: '6 September 2026', sha: '5a13fe9', changes: [
    ...
    'Back buttons added to missing page headers, including Account and Map.',
  ] },
  ...
  },
  {
    ...
    changes: [
      ...
      'The funder money chart now says when no one shares sales, instead of inventing a scale',
      ...
      'Each organisation now provably sees only its own gardens, visits and courses',
