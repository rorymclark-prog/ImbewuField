...
export const SESOTHO_PLANT_GUILDS_DRAFT: SesothoCourseModuleDraft = {
  ...
  title: pair("Plant Selection & Guilds", "Khetho ea limela le lihlopha tsa limela (guilds)", 'machine-draft'),
  description: pair("Choose useful plant partners, return mulch and manage the guild as trees grow.", "Khetha limela tse thusanang, khutlisetsa mulch mobung, 'me u laole guild ha lifate li ntse li hola.", 'machine-draft'),
  lessons: [
    {
      id: "plant-guilds-l1",
      title: pair("Nitrogen Fixers: Choose and Manage Support Plants", "Limela tse lokisang naetrojene (nitrogen): khetha le ho laola limela tsa tšehetso", 'machine-draft'),
      ...
      quiz: [
        {
          ...
          options: [
            ...
            pair("As soil organisms decompose the material", "Ha diphedi tsa mobu di bolisa thepa eo", 'machine-draft'),
    ...
    },
    {
      ...
      quiz: [
        ...
        },
        {
          ...
          sourceCorrectIndex: 1,
          rationale: pair("Flowers can supply resources, but their presence does not guarantee pest control.", "Dithunya di ka fana ka mehloli, empa ho ba teng ha tsona ha ho tiise hore dikokonyana tse senyang di a laoleha.", 'machine-draft'),
        },
      ],
    },
    {
      ...
      quiz: [
        ...
        },
        {
          ...
          options: [
            ...
            pair("Yes, because it fixes nitrogen", "E, hobane e lokisa nitrogen", 'machine-draft'),
