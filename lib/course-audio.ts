...
export const COURSE_NARRATION: Record<string, ModuleNarration> = {
  ...
  'water-harvesting': {
    languages: ['en', 'zu'],
    // English is current; isiZulu is owner-authorized as an unreviewed draft with persistent
    // learner labels. ZU uses zu-ZA-ThandoNeural at -12%; language, local farming, sanitation and
    // listening review remain pending. Slide 21 is static only; proof is in the review record.
    ...
    tracks: [
      { slide: 1,  lesson: null,                  title: 'Water Harvesting', titleByLang: { zu: 'Ukuvunwa Kwamanzi' } },
      { slide: 2,  lesson: null,                  title: 'Learning Outcomes', titleByLang: { zu: 'Imiphumela Yokufunda' } },
      { slide: 3,  lesson: 'water-harvesting-l1', title: 'Two Swale Designs', titleByLang: { zu: 'Izinhlobo Ezimbili Zama-Swale' } },
      { slide: 4,  lesson: 'water-harvesting-l1', title: 'A Swale May Let Water Soak In', titleByLang: { zu: 'I-Swale Ingavumela Amanzi Angene Emhlabathini' } },
      { slide: 5,  lesson: 'water-harvesting-l1', title: 'The Downhill Berm', titleByLang: { zu: 'I-Berm Esehlangothini Eliphansi' } },
      { slide: 6,  lesson: 'water-harvesting-l1', title: 'Storms Need a Safe Overflow', titleByLang: { zu: 'Iziphepho Zidinga Indlela Ephephile Yokuchichima' } },
      { slide: 7,  lesson: 'water-harvesting-l1', title: 'Assess the Overflow Before Digging', titleByLang: { zu: 'Hlola Indlela Yokuchichima Ngaphambi Kokumba' } },
      { slide: 8,  lesson: 'water-harvesting-l1', title: 'Check the Site Before Digging', titleByLang: { zu: 'Hlola Indawo Ngaphambi Kokumba' } },
      { slide: 9,  lesson: 'water-harvesting-l1', title: 'Watch: Roots Help Hold Soil', titleByLang: { zu: 'Buka: Izimpande Zisiza Ukubamba Umhlabathi' } },
      { slide: 10, lesson: 'water-harvesting-l2', title: 'Store Rain for the Dry Season', titleByLang: { zu: 'Gcina Amanzi Emvula Esikhathi Esomile' } },
      { slide: 11, lesson: 'water-harvesting-l2', title: 'Design the Spillway Before the Wall', titleByLang: { zu: 'Klama I-Spillway Ngaphambi Kodonga' } },
      { slide: 12, lesson: 'water-harvesting-l2', title: 'Dam and Spillway: A Concept', titleByLang: { zu: 'Idamu Ne-Spillway: Umqondo' } },
      { slide: 13, lesson: 'water-harvesting-l2', title: 'Care for the Dam and Its Banks', titleByLang: { zu: 'Nakekela Idamu Namabhange Alo' } },
      { slide: 14, lesson: 'water-harvesting-l3', title: 'Your Roof Is a Harvesting Surface', titleByLang: { zu: 'Uphahla Lwakho Lungavuna Amanzi' } },
      { slide: 15, lesson: 'water-harvesting-l3', title: 'Divert the Dirty First Flush', titleByLang: { zu: 'Phambukisa Amanzi Okuqala Angcolile' } },
      { slide: 16, lesson: 'water-harvesting-l3', title: 'First Flush to Tank: A Concept', titleByLang: { zu: 'Amanzi Okuqala Aya Ethangini: Umqondo' } },
      { slide: 17, lesson: 'water-harvesting-l3', title: 'Match Tank Size to Water Demand', titleByLang: { zu: 'Qhathanisa Usayizi Wethangi Nesidingo Samanzi' } },
      { slide: 18, lesson: 'water-harvesting-l3', title: 'Keep Stored Water Protected', titleByLang: { zu: 'Vikela Amanzi Agciniwe' } },
      { slide: 19, lesson: 'water-harvesting-l4', title: 'Used Water Varies by Source', titleByLang: { zu: 'Amanzi Asetshenzisiwe Ayahluka Ngomthombo' } },
      { slide: 20, lesson: 'water-harvesting-l4', title: 'Get Local Advice Before Any Reuse', titleByLang: { zu: 'Thola Iseluleko Sendawo Ngaphambi Kokuphinda Usebenzise Amanzi' } },
      { slide: 21, lesson: 'water-harvesting-l4', title: 'A Picture Is Not a Farm Design', titleByLang: { zu: 'Isithombe Asiwona Umklamo Wepulazi' } },
      { slide: 22, lesson: 'water-harvesting-l4', title: 'Prevent Contact and Pollution', titleByLang: { zu: 'Vimbela Ukuthintana Nokungcolisa' } },
      { slide: 23, lesson: null,                  title: 'Field Assignment', titleByLang: { zu: 'Umsebenzi Wasensimini' } },
      { slide: 24, lesson: null,                  title: 'Check Your Work', titleByLang: { zu: 'Hlola Umsebenzi Wakho' } },
    ],
  },
  'soil-health': {
    languages: ['zu', 'en'],
    // isiZulu is an AI review draft recorded with zu-ZA-ThandoNeural at -12%. Its
    // word-boundary and decode checks are automated; fluent/local-farming review is pending.
    // Corrected English uses en-ZA-LukeNeural at -12%; its listening review is separate.
    tracks: [
      { slide: 1,  lesson: null,             title: 'Soil Health & Composting', titleByLang: { zu: 'Impilo Yomhlabathi Ne-Compost' } },
      { slide: 2,  lesson: null,             title: 'Why This Matters', titleByLang: { zu: 'Kungani Lokhu Kubalulekile' } },
      { slide: 3,  lesson: null,             title: 'Learning Outcomes', titleByLang: { zu: 'Imiphumela Yokufunda' } },
      { slide: 4,  lesson: 'soil-health-l1', title: 'Soil Is Alive', titleByLang: { zu: 'Umhlabathi Uyaphila' } },
      { slide: 5,  lesson: 'soil-health-l1', title: 'Watch: Read Your Soil', titleByLang: { zu: 'Bheka Umhlabathi' } },
      { slide: 6,  lesson: 'soil-health-l1', title: 'Explore Soil Texture with a Jar', titleByLang: { zu: 'Hlola Ukuthungwa Komhlabathi Ngebhodlela' } },
      { slide: 7,  lesson: 'soil-health-l1', title: 'Read the Jar Carefully', titleByLang: { zu: 'Funda Izingqimba Zasebhodleleni Ngokucophelela' } },
      { slide: 8,  lesson: 'soil-health-l1', title: 'Investigate Before You Treat', titleByLang: { zu: 'Hlola Ngaphambi Kokwelapha' } },
      { slide: 9,  lesson: 'soil-health-l2', title: 'Compost Feeds the Soil', titleByLang: { zu: 'I-Compost Yondla Umhlabathi' } },
      { slide: 10, lesson: 'soil-health-l2', title: 'Watch: Build the Compost Heap', titleByLang: { zu: 'Yakha Inqwaba Ye-Compost' } },
      { slide: 11, lesson: 'soil-health-l2', title: 'Balance Browns and Greens', titleByLang: { zu: 'Linganisa Ama-Browns Nama-Greens' } },
      { slide: 12, lesson: 'soil-health-l2', title: 'Heat Alone Is Not a Safety Check', titleByLang: { zu: 'Ukushisa Kukodwa Akufakazeli Ukuphepha' } },
      { slide: 13, lesson: 'soil-health-l2', title: 'Keep Seed Pods and Contaminants Out', titleByLang: { zu: 'Gcina Ama-Pod Embewu Nezinto Ezingcolile Ngaphandle' } },
      { slide: 14, lesson: 'soil-health-l3', title: 'Watch: Bare Soil and Mulch', titleByLang: { zu: 'Umhlabathi Ongenalutho Ne-Mulch' } },
      { slide: 15, lesson: 'soil-health-l3', title: 'Mulch Protects the Ground', titleByLang: { zu: 'I-Mulch Ivikela Umhlabathi' } },
      { slide: 16, lesson: 'soil-health-l3', title: 'Cover Crops Between Seasons', titleByLang: { zu: 'Izitshalo Zokumboza Umhlabathi Phakathi Kwezilimo' } },
      { slide: 17, lesson: 'soil-health-l3', title: 'Worm Castings and Liquid Drainage', titleByLang: { zu: 'Ama-Worm Castings Noketshezi Oluphuma Emgqonyeni' } },
      { slide: 18, lesson: 'soil-health-l3', title: 'Protect Soil All Year', titleByLang: { zu: 'Vikela Umhlabathi Unyaka Wonke' } },
      { slide: 19, lesson: null,             title: 'Field Assignment', titleByLang: { zu: 'Umsebenzi Wensimu' } },
      { slide: 20, lesson: null,             title: 'Field Action', titleByLang: { zu: 'Isenzo SasePulazini' } },
    ],
  },
  'vegetables-staples': {
    languages: ['en', 'zu'],
    // Corrected English recorded 2026-09-20, en-ZA-LukeNeural at -12%.
    // English remains at -12% with its existing Luke voice. IsiZulu draft generated 2026-09-24
    // with zu-ZA-ThandoNeural at -12%. All 18 clips match source word boundaries and decode;
    // fluent isiZulu, local farming and listening reviews remain pending.
    tracks: [
      { slide: 1,  lesson: null,                    title: 'Vegetables and Staple Crops', titleByLang: { zu: 'Imifino Nezitshalo Eziyisisekelo' } },
      { slide: 2,  lesson: null,                    title: 'Why This Matters', titleByLang: { zu: 'Kungani Lokhu Kubalulekile' } },
      { slide: 3,  lesson: null,                    title: 'Learning Outcomes', titleByLang: { zu: 'Imiphumela Yokufunda' } },
      { slide: 4,  lesson: 'vegetables-staples-l1', title: 'Roots Need Loose Soil, Paths Need Your Feet', titleByLang: { zu: 'Izimpande Zidinga Inhlabathi Etshelekile, Izindlela Zidinga Izinyawo Zakho' } },
      { slide: 5,  lesson: 'vegetables-staples-l1', title: 'Choose the Bed for the Soil and Rainfall', titleByLang: { zu: 'Khetha Ibhedi Ngokwenhlabathi Nemvula' } },
      { slide: 6,  lesson: 'vegetables-staples-l1', title: 'Seed or Seedling?', titleByLang: { zu: 'Imbewu Noma Isithombo?' } },
      { slide: 7,  lesson: 'vegetables-staples-l1', title: 'Mark the Working Shape', titleByLang: { zu: 'Maka Umumo Wombhede' } },
      { slide: 8,  lesson: 'vegetables-staples-l2', title: 'A Sowing Rhythm Keeps Food Moving', titleByLang: { zu: 'Isigqi Sokuhlwanyela Sigcina Ukudla Kuqhubeka' } },
      { slide: 9,  lesson: 'vegetables-staples-l2', title: 'Sow Little and Often', titleByLang: { zu: 'Hlwanyela Kancane Futhi Njalo' } },
      { slide: 10, lesson: 'vegetables-staples-l2', title: 'Each Crop Earns Its Place', titleByLang: { zu: 'Isitshalo Ngasinye Sidinga Isizathu Sendawo Yaso' } },
      { slide: 11, lesson: 'vegetables-staples-l2', title: 'Plan Backwards From Your Hungry Gap', titleByLang: { zu: 'Hlela Usuka Emuva Esikhathini Sokushoda Kokudla' } },
      { slide: 12, lesson: 'vegetables-staples-l3', title: 'Staples Are Food Insurance', titleByLang: { zu: 'Izitshalo Eziyisisekelo Ziwukuvikeleka Kokudla' } },
      { slide: 13, lesson: 'vegetables-staples-l3', title: 'Different Staples Protect Against Different Risks', titleByLang: { zu: 'Izitshalo Eziyisisekelo Ezahlukene Zivikela Ezingozini Ezahlukene' } },
      { slide: 14, lesson: 'vegetables-staples-l3', title: 'Diversity Keeps Food Moving', titleByLang: { zu: 'Ukwahlukahluka Kugcina Ukudla Kuqhubeka' } },
      { slide: 15, lesson: 'vegetables-staples-l4', title: 'Pests Are Messengers Before They Are Enemies', titleByLang: { zu: 'Izinambuzane Ziyizithunywa Ngaphambi Kokuba Zibe Yizitha' } },
      { slide: 16, lesson: 'vegetables-staples-l4', title: 'Treat the Cause Before the Insect', titleByLang: { zu: 'Bheka Imbangela Ngaphambi Kwesinambuzane' } },
      { slide: 17, lesson: null,                    title: 'Field Assignment', titleByLang: { zu: 'Umsebenzi Wensimu' } },
      { slide: 18, lesson: null,                    title: 'Field Action', titleByLang: { zu: 'Isenzo SaseNsimini' } },
    ],
  },
  'plant-guilds': {
  ...
  'food-forest': {
    languages: ['en', 'zu'],
    // Corrected English recorded 2026-09-20, en-ZA-LukeNeural at -12%.
    // isiZulu draft generated 2026-09-24 with zu-ZA-ThandoNeural at -12%. Word-boundary and
    // decode proofs passed; fluent isiZulu, local farming and listening review remain pending.
    tracks: [
      { slide: 1,  lesson: null,             title: 'Food Forest Design', titleByLang: { zu: 'Ukuklama I-Food Forest' } },
      { slide: 2,  lesson: null,             title: 'Why This Matters', titleByLang: { zu: 'Kungani Lokhu Kubalulekile' } },
      { slide: 3,  lesson: null,             title: 'Learning Outcomes', titleByLang: { zu: 'Imiphumela Yokufunda' } },
      { slide: 4,  lesson: 'food-forest-l1', title: 'The Forest Uses Every Layer', titleByLang: { zu: 'Ihlathi Lisebenzisa Wonke Ama-Layer' } },
      { slide: 5,  lesson: 'food-forest-l1', title: 'Watch: Read the Seven Planting Layers', titleByLang: { zu: 'Buka: Funda Izendlalelo Eziyisikhombisa Zokutshala' } },
      { slide: 6,  lesson: 'food-forest-l1', title: 'The Seven Layers', titleByLang: { zu: 'Ama-Layer Ayisikhombisa' } },
      { slide: 7,  lesson: 'food-forest-l1', title: 'Read a Layered Planting Example', titleByLang: { zu: 'Funda Isibonelo Sokutshala Ngezendlalelo' } },
      { slide: 8,  lesson: 'food-forest-l1', title: 'Care Changes as Plants Grow', titleByLang: { zu: 'Ukunakekela Kuyashintsha Njengoba Izitshalo Zikhula' } },
      { slide: 9,  lesson: 'food-forest-l2', title: 'Choose for Your Site', titleByLang: { zu: 'Khetha Ngokwendawo Yakho' } },
      { slide: 10, lesson: 'food-forest-l2', title: 'Watch: Match the Species to the Climate', titleByLang: { zu: 'Buka: Qondanisa Izinhlobo Nesimo Sezulu' } },
      { slide: 11, lesson: 'food-forest-l2', title: 'Check the Highveld Examples', titleByLang: { zu: 'Hlola Izibonelo Zase-Highveld' } },
      { slide: 12, lesson: 'food-forest-l2', title: 'Check the Warm-Region Examples', titleByLang: { zu: 'Hlola Izibonelo Zezifunda Ezifudumele' } },
      { slide: 13, lesson: 'food-forest-l2', title: 'Include Locally Appropriate Indigenous Plants', titleByLang: { zu: 'Faka Izitshalo Zomdabu Ezifanele Indawo' } },
      { slide: 14, lesson: 'food-forest-l3', title: 'Plan the Sequence for the Site', titleByLang: { zu: 'Hlela Ukulandelana Ngokwendawo' } },
      { slide: 15, lesson: 'food-forest-l3', title: 'Watch: Care for a Young Food Forest', titleByLang: { zu: 'Buka: Nakekela I-Food Forest Encane' } },
      { slide: 16, lesson: 'food-forest-l3', title: 'Prepare a Manageable First Area', titleByLang: { zu: 'Lungisa Indawo Yokuqala Elawulekayo' } },
      { slide: 17, lesson: 'food-forest-l3', title: 'Adjust as the Trees Grow', titleByLang: { zu: 'Lungisa Ukutshala Njengoba Izihlahla Zikhula' } },
      { slide: 18, lesson: 'food-forest-l3', title: 'Plant with Reliable Moisture', titleByLang: { zu: 'Tshala Uma Kukhona Umswakama Othembekile' } },
      { slide: 19, lesson: null,             title: 'Field Assignment', titleByLang: { zu: 'Umsebenzi Wasepulazini' } },
      { slide: 20, lesson: null,             title: 'Field Action', titleByLang: { zu: 'Isenzo SasePulazini' } },
    ],
  },
  'small-livestock': {
  ...
  'market-community': {
    ...
    tracks: [
      ...
      { slide: 2,  lesson: null,                  title: 'Why This Matters', titleByLang: { zu: 'Kungani Lokhu Kubalulekile' } },
      { slide: 3,  lesson: null,                  title: 'Learning Outcomes', titleByLang: { zu: 'Imiphumela Yokufunda' } },
      { slide: 4,  lesson: 'market-community-l1', title: 'Watch: What the Farm Record Shows', titleByLang: { zu: 'Buka: Okuboniswa Irekhodi Lepulazi' } },
      { slide: 5,  lesson: 'market-community-l1', title: 'Record Every Harvest', titleByLang: { zu: 'Bhala Phansi Sonke Isivuno' } },
      { slide: 6,  lesson: 'market-community-l1', title: 'Let One Season Answer Questions', titleByLang: { zu: 'Isizini Eyodwa Iphendula Imibuzo' } },
      { slide: 7,  lesson: 'market-community-l1', title: 'Find the True Cost', titleByLang: { zu: 'Thola Izindleko Zangempela' } },
      { slide: 8,  lesson: 'market-community-l1', title: 'Plan for the Food Gap', titleByLang: { zu: 'Hlela Ngesikhathi Sokushoda Kokudla' } },
      { slide: 9,  lesson: 'market-community-l2', title: 'Watch: Where Surplus Can Go', titleByLang: { zu: 'Buka: Lapho Okusele Kungaya Khona' } },
      { slide: 10, lesson: 'market-community-l2', title: 'Know Your Customer', titleByLang: { zu: 'Yazi Umthengi Wakho' } },
      ...
      { slide: 18, lesson: 'market-community-l3', title: 'Share Skills and Check Results', titleByLang: { zu: 'Yabelanani Ngamakhono Niphinde Nihlole Imiphumela' } },
      { slide: 19, lesson: null,                  title: 'Field Assignment: Make a Farm Record', titleByLang: { zu: 'Umsebenzi Wasepulazini: Yenza Irekhodi Lepulazi' } },
      { slide: 20, lesson: null,                  title: 'Field Action: Use the Record', titleByLang: { zu: 'Isenzo Sasepulazini: Sebenzisa Irekhodi' } },
    ],
  },
};
