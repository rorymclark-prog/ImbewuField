/** Unpublished source-paired Xitsonga machine draft for Water Harvesting. */
import type { XitsongaCourseModuleDraft } from './course-translation-drafts-ts.ts';

export const XITSONGA_WATER_HARVESTING_DRAFT = {
  "id": "water-harvesting",
  "language": "ts",
  ...
  "title": {
    ...
    "xitsongaDraft": "Ku hlengeleta Mati",
    "reviewStatus": "machine-draft"
  },
  "description": {
    "sourceEnglish": "Swales, berms, dams, rainwater tanks and greywater — slow, spread and sink every drop.",
    "xitsongaDraft": "Swales, berms, dams, rainwater tanks and greywater — slow, spread and sink every drop.",
    "reviewStatus": "hold"
  },
  "lessons": [
    {
      ...
      "keyPoints": [
        ...
        },
        {
          ...
          "xitsongaDraft": "Hlayisa misava yi funengetekile kahle naswona u pulana laha mati yo tala ma nga khulukelaka kona hi vuhlayiseki.",
          "reviewStatus": "machine-draft"
        },
        {
        ...
        },
        {
          ...
          "xitsongaDraft": "Xifaniso xa miehleketo a hi pulani yo aka ha yona.",
          "reviewStatus": "machine-draft"
        }
      ],
      "quiz": [
        {
          "question": {
            ...
            "xitsongaDraft": "A farmer planned a level contour swale. After heavy rain, one end holds most of the water. What should the farmer check before changing the earthwork?",
            "reviewStatus": "hold"
          },
          "options": [
            {
              "sourceEnglish": "Whether the trench can be made deeper without a site check",
              "xitsongaDraft": "Whether the trench can be made deeper without a site check",
              "reviewStatus": "hold"
            },
            {
              ...
              "xitsongaDraft": "The intended design and measured levels with a trained local adviser; an unintended low point may be present",
              "reviewStatus": "hold"
            },
            {
              "sourceEnglish": "Whether a new dam at the lowest point will catch every overflow",
              "xitsongaDraft": "Whether a new dam at the lowest point will catch every overflow",
              "reviewStatus": "hold"
            },
            {
              "sourceEnglish": "Whether the soil should be compacted to stop all infiltration",
              "xitsongaDraft": "Whether the soil should be compacted to stop all infiltration",
              "reviewStatus": "hold"
            }
          ],
          ...
          "rationale": {
            ...
            "xitsongaDraft": "A level contour design should spread water along its length. Uneven filling may indicate an unintended low point, but some swales are intentionally graded to a safe outlet. Check the actual design, soil and overflow route before altering it.",
            "reviewStatus": "hold"
          }
        },
        {
          "question": {
            ...
            "xitsongaDraft": "A farmer wants to control erosion on steep land. What should she do before digging?",
            "reviewStatus": "hold"
          },
          "options": [
            {
              "sourceEnglish": "Standard swales dug as deep as possible",
              "xitsongaDraft": "Standard swales dug as deep as possible",
              "reviewStatus": "hold"
            },
            {
              "sourceEnglish": "Keep ground covered and get a site assessment for suitable erosion controls",
              "xitsongaDraft": "Keep ground covered and get a site assessment for suitable erosion controls",
              "reviewStatus": "hold"
            },
            {
              "sourceEnglish": "A large dam at the bottom to catch all runoff",
              "xitsongaDraft": "A large dam at the bottom to catch all runoff",
              "reviewStatus": "hold"
            },
            {
              "sourceEnglish": "Compacting the soil surface with a roller",
              "xitsongaDraft": "Compacting the soil surface with a roller",
              "reviewStatus": "hold"
            }
          ],
          "sourceCorrectIndex": 1,
          "rationale": {
            ...
            "xitsongaDraft": "Slope alone is not enough to choose an earthwork. Soil, drainage, stability and storm flow must also be assessed.",
            "reviewStatus": "hold"
          }
        }
      ]
      ...
      "quiz": [
        {
          ...
          "options": [
            ...
            },
            {
              ...
              "xitsongaDraft": "Ask the municipality and a qualified sanitation adviser to check the source, service status, intended use and site",
              "reviewStatus": "hold"
            },
            {
              "sourceEnglish": "Use it if it looks clear",
              "xitsongaDraft": "Use it if it looks clear",
              "reviewStatus": "hold"
            },
            {
        ...
        },
        {
          ...
          "options": [
            ...
            },
            {
              ...
              "xitsongaDraft": "Mulch removes every harmful substance",
              "reviewStatus": "hold"
            }
          ],
          "sourceCorrectIndex": 1,
  ...
  "holds": [
    ...
    },
    {
      ...
      "sourceText": "Whether the trench can be made deeper without a site check",
    ...
    },
    {
      ...
      "sourceText": "The intended design and measured levels with a trained local adviser; an unintended low point may be present",
      "reason": "This item depends on earthwork or wastewater-safety judgement; retain exact English pending fluent technical review."
    },
    {
      "lessonId": "water-harvesting-l1",
      "field": "quiz[0].options[2]",
      "sourceText": "Whether a new dam at the lowest point will catch every overflow",
      "reason": "This item depends on earthwork or wastewater-safety judgement; retain exact English pending fluent technical review."
    },
    {
      "lessonId": "water-harvesting-l1",
      "field": "quiz[0].options[3]",
      "sourceText": "Whether the soil should be compacted to stop all infiltration",
      "reason": "This item depends on earthwork or wastewater-safety judgement; retain exact English pending fluent technical review."
    },
    {
      "lessonId": "water-harvesting-l1",
      "field": "quiz[0].question",
      "sourceText": "A farmer planned a level contour swale. After heavy rain, one end holds most of the water. What should the farmer check before changing the earthwork?",
    ...
    },
    {
      ...
      "sourceText": "A level contour design should spread water along its length. Uneven filling may indicate an unintended low point, but some swales are intentionally graded to a safe outlet. Check the actual design, soil and overflow route before altering it.",
    ...
    },
    {
      ...
      "sourceText": "Standard swales dug as deep as possible",
      "reason": "This item depends on earthwork or wastewater-safety judgement; retain exact English pending fluent technical review."
    },
    {
      "lessonId": "water-harvesting-l1",
      "field": "quiz[1].options[1]",
      "sourceText": "Keep ground covered and get a site assessment for suitable erosion controls",
      "reason": "This item depends on earthwork or wastewater-safety judgement; retain exact English pending fluent technical review."
    },
    {
      "lessonId": "water-harvesting-l1",
      "field": "quiz[1].options[2]",
      "sourceText": "A large dam at the bottom to catch all runoff",
      "reason": "This item depends on earthwork or wastewater-safety judgement; retain exact English pending fluent technical review."
    },
    {
      "lessonId": "water-harvesting-l1",
      "field": "quiz[1].options[3]",
      "sourceText": "Compacting the soil surface with a roller",
      "reason": "This item depends on earthwork or wastewater-safety judgement; retain exact English pending fluent technical review."
    },
    {
      "lessonId": "water-harvesting-l1",
      "field": "quiz[1].question",
      "sourceText": "A farmer wants to control erosion on steep land. What should she do before digging?",
      "reason": "This question tests safety-critical or site-specific water design; retain exact English pending fluent technical review."
    },
    {
      "lessonId": "water-harvesting-l1",
