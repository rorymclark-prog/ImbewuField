...
export const CALENDAR_MAINTAIN_ZU = [
  [
    ...
    'Phendula umquba njalo ngemva kwamasonto amabili — ukushisa kusheshisa ukubola.',
  ],
  [
    // Held at the exact source: the draft lost the difference between depth and amount.
    'Continue deep watering — soil dries fast',
    'Faka umquba eduze kwe-maize uma ukukhula kuhamba kancane.',
  ...
  [
    'Susa izitshalo zasehlobo emibhedeni bese ufaka umquba ngaphambi kwenkathi epholile.',
  ...
  [
    ...
    'Hlwanyela spinach ne-carrots emibhedeni efakwe umquba kahle.',
    'Nciphisa izikhathi zokunisela njengoba amazinga okushisa ehla.',
    'Faka i-mulch yomquba ukuze uvikele umhlabathi ebusuku obupholile.',
  ],
  [
    ...
    'Qala inqwaba yesibili yomquba ngamaqabunga omile asekwindla.',
  ],
  [
    'Vikela izithombo ezintekenteke eqhweni usebenzisa indwangu yomthunzi noma isembozo semigqa.',
  ...
  [
    ...
    'Lungisa umquba ngezinto ezomile ukuze wondle izitshalo entwasahlobo.',
  ...
  [
    ...
    'Lungisa imibhede yasentwasahlobo — faka umquba ngaphambi kokufika kokushisa.',
    'Ithuba lokugcina lokutshala carrots ngaphambi kokuba ukufudumala kwentwasahlobo kubambezele ukuhluma.',
    'Susa indwangu evikela eqhweni njengoba izinsuku zifudumala — vumela ilanga liqinise izithombo.',
  ],
  [
    ...
    'Faka itiye lomquba emibhedeni ngaphambi kokutshala izithombo.',
  ],
  [
  ...
  [
    ...
    'Gcina umquba umanzi lapho kushisa.',
  ],
  [
...
export const CALENDAR_LIMA_ADVICE_ZU = [
  ...
  'Hlwanyela spinach ngokulandelana njalo ngemva kwamasonto amathathu kusukela ngoMeyi kuya kuJulayi ukuze uqhubeke nokuvuna. Ama-carrots ahlwanyelwe manje azolunga ngo-Agasti. Ikwindla nayo yisikhathi esihle sokuthuthukisa umhlabathi — mba umquba ovuthiwe uwufake manje, bese izikelemu ziqhubeka nomsebenzi ebusika.',
  'UJuni uyinyanga ebanda kakhulu eHighveld. Ezindaweni ezivame ukuba neqhwa, vikela izithombo zesipinashi ebusuku usebenzisa indwangu yoboya noma utshani obomile. Ogwini naseKapa, uJuni uyisikhathi esihle sokutshala — gxila ekwandiseni isivuno ngaphambi kokufika kokushisa kwentwasahlobo.',
  ...
  'U-Agasti ubonisa ushintsho. Hlwanyela i-tomato seeds endlini manje — ukuyiqala emasontweni angu-6 kuya kwangu-8 ngaphambi kweqhwa lokugcina kuzinikeza isiqalo esihle izithombo. Ezindaweni ezisogwini ezingenalo iqhwa, ungahlwanyela i-tomatoes ngqo emhlabathini ngasekupheleni kuka-Agasti. Qala ukukhulula umhlabathi oqiniswe ubusika kuyo yonke imibhede.',
...
export const CROP_PLAN_MONTH_FOCUS_ZU = [
  ...
  'Ukuqala kwekwindla — hlwanyela spinach, carrots ne-garlic; faka umquba.',
  ...
  'Ubusika — vikela izithombo eqhweni; vuna imifino enamaqabunga nezimpande.',
