...
export const PROGRESS_TEMPLATES: { id: string; category: ProgressArea; title: string; unit: string; method: string }[] = [
  ...
  // ACT publishes garden networks, nurseries, donated produce and training as
  // distinct outputs: https://projectafrica.com/social-employment-fund/
  // These are optional definitions, not ACT-approved targets or recorded results.
  { id:'produce-donated', category:'growing', title:'Produce donated to communities', unit:'kg', method:'Use dated weighed donation records with garden codes and recipient group references. Exclude produce kept by the growing household, sales and stored food. This is a subset of total food use; do not add it to that total.' },
  { id:'demonstration-gardens', category:'growing', title:'Active demonstration gardens', unit:'gardens', method:'Count distinct sites with a dated check of active growing and recorded demonstration or mentoring use. Keep this subset separate from the total garden count and state the reporting period.' },
  { id:'seedlings-distributed', category:'growing', title:'Seedlings distributed from nurseries', unit:'seedlings', method:'Use dated nursery dispatch records linked to receiving garden codes. Count each seedling once; exclude plants still in the nursery and keep establishment or survival checks separate.' },
  ...
  { id:'invasive-area', category:'land-nature', title:'Area with invasive vegetation managed', unit:'ha', method:'Use dated mapped work footprints and the agreed management activity. Exclude overlapping repeat treatments from unique area; report those treatments separately. A treated area does not establish eradication or ecological recovery.' },
  ...
  { id:'course-completion', category:'learning', title:'Participants completing the agreed course', unit:'people', method:'Count distinct participant IDs meeting the agreed course completion requirements within the reporting period. Link the required session registers; one session attendance or a certificate photograph alone does not establish course completion.' },
