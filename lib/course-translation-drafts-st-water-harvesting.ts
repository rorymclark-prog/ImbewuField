  ...
  lessons: [
    {
      ...
      infographicAlt: pair("Concept cross-section of a level contour swale with a raised mound below it. Arrows show runoff slowing and spreading; infiltration depends on the soil and site.", "Karolo e sehiloeng ea mohopolo ea mokeremete o lekaneng moeling (level contour swale) o nang le qubu e phahamisitsoeng ka tlase ho oona. Mesebe e bontša metsi a phallang a fokotsa lebelo le ho phatlalala; ho teba ha metsi ho itshetlehile ka mobu le setsha.", "machine-draft"),
      ...
      keyPoints: [
        pair("A level contour swale can hold runoff for infiltration on a suitable site; other swales need a designed grade and safe outlet", "Foro e lekaneng moeling (level contour swale) e ka ts'oara metsi a phallang hore a tebe setsheng se loketseng; mekoti e meng e hloka tshekamo e raliloeng le sebaka se bolokehileng sa ho tsoela kantle", "machine-draft"),
      ...
      quiz: [
        {
          question: pair("A farmer planned a level contour swale. After heavy rain, one end holds most of the water. What should the farmer check before changing the earthwork?", "Sehoai se ralile foro e lekaneng moeling (level contour swale). Kamora pula e matla, ntlha e 'ngoe e ts'oara boholo ba metsi. Sehoai se lokela ho hlahloba eng pele se fetola mosebetsi oa mobu?", "machine-draft"),
          options: [
          ...
          rationale: pair("A level contour design should spread water along its length. Uneven filling may indicate an unintended low point, but some swales are intentionally graded to a safe outlet. Check the actual design, soil and overflow route before altering it.", "Moralo o lekaneng moeling (level contour design) o lokela ho phatlalatsa metsi le bolelele ba oona. Ho tlala ho sa lekanang ho ka bontša sebaka se tlase se sa reroang, empa mekoti e meng (swales) e etsetsoa ho sekama ka morero ho ea sebakeng se bolokehileng sa ho tsoela kantle. Hlahloba moralo oa sebele, mobu le tsela ea metsi a mangata pele o e fetola.", "machine-draft"),
        },
        {
