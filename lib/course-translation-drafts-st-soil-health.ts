...
export const SESOTHO_SOIL_HEALTH_DRAFT: SesothoCourseModuleDraft = {
  ...
  title: pair("Soil Health & Composting", "Bophelo bo Botle ba Mobu le ho Etsa Manyolo a Bolaang (Compost)", "machine-draft"),
  description: pair("Build living soil with compost, mulch, cover crops and worm farms.", "Aha mobu o phelang ka compost, mulch, dijalo tse sireletsang mobu (cover crops) le mapolasi a diboko.", "machine-draft"),
  lessons: [
    {
      id: "soil-health-l1",
    ...
    },
    {
      ...
      keyPoints: [
        ...
        pair("Judge readiness from the compost condition, not a fixed regional timetable", "Ahlola ho loka ho tswa boemong ba compost, eseng lenaneong le behilweng la nako la lebatowa", "machine-draft"),
      ],
      quiz: [
        {
          ...
          options: [
            pair("Add more nitrogen-rich green material", "Eketsa disebediswa tse tala tse nang le nitrogen e ngata", "machine-draft"),
            pair("Add more dry carbon material like straw and turn the heap", "Eketsa disebediswa tse omileng tsa carbon jwalo ka jwang bo omileng (straw) mme o phethole qubu", "machine-draft"),
        ...
        {
          question: pair("Why keep wattle seed pods out of an ordinary compost heap?", "Ke hobaneng ha o lokela ho boloka makgapha a dipeo tsa wattle kantle ho qubu e tlwaelehileng ya compost?", "machine-draft"),
          options: [
            pair("Bark makes every heap too hot", "Makgapetla a difate a etsa hore qubu e nngwe le e nngwe e tjhese haholo", "machine-draft"),
            pair("Some seeds may survive and spread when the compost is used", "Dipeo tse ding di ka nna tsa pholoha mme tsa nama ha compost e sebediswa", "machine-draft"),
    ...
    },
    {
      ...
      keyPoints: [
        pair("Protect exposed soil with suitable cover", "Sireletsa mobu o pepesitsweng ka sekoahelo se loketseng", "machine-draft"),
        pair("Keep mulch away from trunks and stems", "Boloka mulch hole le dithito le makala a dimela", "machine-draft"),
        pair("Choose cover crops for local water, weather and the following crop", "Kgetha dijalo tse sireletsang mobu ho latela metsi a lehae, maemo a leholimo le sejalo se latelang", "machine-draft"),
      ...
      quiz: [
        {
          question: pair("A Highveld farmer harvests maize in April and leaves the field bare all winter. What are the two main risks?", "Molemi wa Highveld o kotula poone (maize) ka Mmesa mme o siea tshimo e hlobotse mariha kaofela. Dikotsi tse pedi tse ka sehloohong ke dife?", "machine-draft"),
          options: [
            ...
            pair("Soil pH drops and nitrogen builds up", "PH ya mobu e a theoha mme nitrogen e a bokellana", "machine-draft"),
          ],
          sourceCorrectIndex: 2,
        ...
        {
          question: pair("What should you remember about liquid draining from a worm bin?", "O lokela ho hopola eng ka mokelikeli o rothang ho tswa moqomong wa diboko?", "machine-draft"),
          options: [
            pair("It is always safe on salad leaves", "O dula o bolokehile kamehla holima mahlaku a salate", "machine-draft"),
            ...
            pair("It is identical to finished worm castings", "O tswnana hantle le manyolo a phethilweng a diboko (worm castings)", "machine-draft"),
            pair("A fixed dilution makes every liquid safe", "Ho hlapolla ho itseng ho behilweng ho etsa hore mokelikeli o mong le o mong o bolokehe", "machine-draft"),
          ],
          sourceCorrectIndex: 1,
