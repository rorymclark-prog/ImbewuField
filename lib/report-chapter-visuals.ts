...
export const REPORT_ART_READY=new Set(['roof-to-tank','swale-section','drip-bed','soil-layers','trench-bed','crop-rotation','guild-layers','windbreak-section','sun-house','zones','chicken-tractor','firebreak','market-table','five-year-change']);
