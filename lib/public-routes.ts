 ...
 *
 * WHY IT IS SAFE TO LET THESE TWO THROUGH, and why the list must stay short. A route may only
...
export const PUBLIC_MARKETING_ROUTES: readonly string[] = ['/partners', '/pitch'];
