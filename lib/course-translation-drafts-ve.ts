  ...
  lessons: [
    {
      ...
      body: pair(
        ...
        "Permaculture yo thewa kha milayo miraru ya vhuḓifari. U Ṱhogomela Mavu na Mupo (Earth Care) zwi amba u dzhia mavu, maḓi, zwimela na zwipuka sa maitele a no tshila a fanelaho u tsireledzwa, hu si zwiko zwine zwa fanela u fhedzwa. U Ṱhogomela Vhathu (People Care) zwi amba uri ṱhoḓea dza muṱa waṋu dzi dzia u ranga, ha kona u tevhela dza tshitshavha tsha haṋu. U Kovhelana ho Fanelaho (Fair Share) zwi amba u dzhia fhedzi zwine na zwi ṱoḓa nahone na vhuedzedza zwo salaho (surplus) — mbeu, zwiḽiwa, maḓi, nḓivho — murahu kha maitele.\n\nHezwi a si mihumbulo fhedzi i sa vhonali. Mulimi ane a rengisa makumba oṱhe na miroho yoṱhe fhedzi a si siele ṱafula ḽa muṱa tshithu u khou pfuka u Ṱhogomela Vhathu. Tshitshavha tshine tsha thivhela tshisima tshi kovhelanwaho nga luhura tshi khou pwanya u Kovhelana ho Fanelaho.\n\nMilayo ya vhuḓifari ndi ya ndeme ngauri i ni thusa u dzhia tsheo musi hu si na bugu ya milayo — muhura ane a khou humbela u fulisa kholomo nga murahu ha gomelelo, muyaḓadi une wa khou tshinyadza dzi-swale dzaṋu. Fhaṱani hezwi zwiraru kha nḓila ine na humbula ngayo musi ni sa athu fhaṱa tshithu fhasi.",
      ),
      keyPoints: [
        pair(
      ...
      quiz: [
        {
          question: pair(
            ...
            "Mulimi u rengisa tshikoli (maize) tshoṱhe tsho salaho fhedzi a si vhulunge tshithu u itela manyoro a zwo sinaho (composting) kana u vhulunga mbeu. Ndi ufhio mulayo wa vhuḓifari une a khou u kundelwa zwihulwane?",
          ),
          options: [
            pair(
              "Earth Care only",
          ...
          rationale: pair(
            ...
            "U Kovhelana ho Fanelaho zwi amba u vhuedzedza tshinwe tsha zwine na dzhia — sa mbeu, compost, kana zwiḽiwa zwa vhaṅwe. U rengisa zwoṱhe na u sa vhulunga tshithu murahu zwi pwanya wonoyo mudzinginyo.",
          ),
        },
        {
          question: pair(
          ...
          options: [
            ...
            pair(
              ...
              "Wanani uri naa u kovhelana ho tendelwa na uri borehole i nga kona u shumela vhashumisi vhoṱhe. Ndi hone fhedzi ni tshi tendelana nga ha nḓila ya u kovhelana nga ndila yo teaho nahone ni bvele phanḓa u sedza vhuimo ha maḓi.",
            ),
            pair(
          ...
          rationale: pair(
            ...
            "U ranga u wana uri ndi kushumisele-ḓe kwa maḓi kwo tendelwaho na uri naa tshiko tshi nga kona u shumela vhashumisi vhoṱhe hu si na u dzhia zwinzhi lwo kalaho. Arali u kovhelana ho tendelwa nahone maḓi e o eḓana, tendelanani nga ha nḓila ya u kovhelana nga ndila yo teaho. U sedza zwi ni thusa u vhona tshanduko; a zwi nei thendelo ya u dzhia maḓi manzhi.",
          ),
        },
      ],
    },
    {
      ...
      infographicAlt: pair(
        ...
        "Maitele a fumi na mavhili a mufhaṱo o vhekanywaho sa zwipiḓa u monymona na tshimela tshiṱuku tsha vhukati, tshiṅwe na tshiṅwe tsho sumbedzwa sa tshifanyiso tsho leluwaho — iṱo ḽa u sedza, ḓoḓi ḽa u fara maḓi, ḓuvha ḽa maanḓa, na mudzinginyo wa u vhuedzedza mitshelo na malatwa.",
      ),
      title: pair(
      ...
      body: pair(
        ...
        "David Holmgren o vhea maitele a fumi na mavhili a mufhaṱo kha Essence of Permaculture. Bill Mollison na David Holmgren vho thoma muhumbulo wa permaculture vhoṱhe. Zwiṅwe zwipiḓa zwiraru zwi no vhulunga mushumo zwa u thoma kha iyi ngudo ndi: sedzani nahone ni shumisane (observe and interact) — sedzani mavu aṋu kha tshifhinga tshoṱhe tsha khalanwaha musi ni sa athu ita mishumo mihulwane ya mavu; farani nahone ni vhulunge maanḓa (catch and store energy) — ṱhogomelani mvula, ḓuvha na biomass musi zwi sa athu bva zwiṱentsini zwaṋu; nahone shumisani magumo nahone ni dzhiele nṱha zwitoko zwa thungo (use edges and value the marginal) — muvhedzi wa luhura kana dindi tsini ha bando zwi nga vha fhethu hu no vhuedza ha u sedza.\n\nZwiṅwe zwine zwa fanela u ḓivhiwa: ni songo bveledza malatwa (produce no waste — masalela a vha compost, compost ya vha mavu), shumisani thandululo ṱhukhu na dzi no ya nga zwiṱuku (use small and slow solutions — bakiti ḽi nga sheledza ndima hu si na muḓagasi), nahone shumisani na u dzhiela nṱha u fhambana ha zwimela (use and value diversity). Tshenyo ya tshifhango kha tshikoli (maize) i bva kha dumbu na vhuimo ha u aluwa ha zwimela.\n\nNangani maitele mavhili kana mararu ane a amba na thaidzo yaṋu khulwanesa nahone ni a shumise nga maanḓa. Zwo salaho zwi ḓo ḓi-vhonadza musi ni tshi khou bvela phanḓa.",
      ),
      keyPoints: [
        pair(
          "Observe your land for a full season before major earthworks",
          "Sedzani mavu aṋu tshifhinga tshoṱhe tsha khalanwaha musi ni sa athu ita mishumo mihulwane ya mavu",
        ),
        pair(
        ...
        pair(
          ...
          "Tshenyo ya tshifhango kha tshikoli (maize) i bva kha dumbu na vhuimo ha u aluwa ha zwimela",
        ),
      ],
      quiz: [
        {
          ...
          options: [
            ...
            pair(
              ...
              "Sedzani he maḓi a elela hone na he a kuvhangana hone lwa khalanwaha nthihi ya mvula",
            ),
            pair(
            ...
            pair(
              ...
              "Humbulani uri muvhumbelo muthihi wa swale u lingana fhethu hoṱhe",
            ),
          ],
          ...
          rationale: pair(
            ...
            "Khalanwaha ya mvula i sumbedza madumbu a no fhira ḽithihi, fhedzi u sedza ndi vhukando ha u ranga fhedzi. Tolani mavu, u vheama ha mavu (slope), u elela ha maḓi (drainage) na gondo ḽo tsireledzeaho ḽa maḓi o kalaho na mueletshedzi wa henefho o gudedzwaho musi ni sa athu bwa.",
          ),
        },
        {
          question: pair(
          ...
          rationale: pair(
            ...
            "U ṱanganya zwi ita uri tshipiḓa tshiṅwe na tshiṅwe tshi shumele vhahura vhatsho — hafha, khuhu dzi laṱa zwikhokhonono nahone dza engedza mupfudze nṱhani ha u dzula zwo ralo dangani ḽo imaho. Mupfudze muswa u nga hwalela zwitzhili, nga zwenezwo tolani ndaulo yo tsireledzeaho musi zwimela zwi ḽiwaho zwi sa athu vhuya.",
          ),
        },
      ],
    },
    {
      ...
      infographicAlt: pair(
        ...
        "Maringi a no ṱanḓavhuwa u bva nḓuni u ya nnḓa. Ringi ḽi re tsini tsini na vothi ḽi ṱhogomelwa ḓuvha ḽiṅwe na ḽiṅwe; ringi ḽiṅwe na ḽiṅwe ḽi re kule ḽi dalelwa lwa si gathi nahone ḽa siilwa ḽo fana na ḓaka.",
      ),
      title: pair(
      ...
      keyPoints: [
        pair(
          ...
          "Kha tsumbo iyi, Zoune 1 i re tsini na nḓu i fara zwilavhele zwine zwa kiwa lunzhi",
        ),
        pair(
        ...
        pair(
          ...
          "Sekithara dzi ita mmapa wa ḓuvha ḽi no ḓa, muya, maḓi a mvula, muyaḓadi na mulilo",
        ),
        pair(
      ...
      quiz: [
        {
          question: pair(
            ...
            "Ni ṱavha zwilavhele kha Zoune 3, tsimu khulwane i re kule na nḓu. Hezwi zwi vhanga thaidzo-ḓe?",
          ),
          options: [
            pair(
        ...
        },
        {
          ...
          options: [
            ...
            pair(
              ...
              "Tsireledzo dza muya a dzi ṱoḓei ngauri mimiya ndi ya zwifhinga zwa khalanwaha",
            ),
          ],
          sourceCorrectIndex: 1,
          rationale: pair(
            ...
            "Tsireledzo ya muya i shuma nga u ima vhukati ha tshiko tsha muya na zwine zwa nga tshinyala — ngauralo i fanela u vha kha thungo ine muya wa khou bva khayo.",
          ),
        },
      ],
    },
