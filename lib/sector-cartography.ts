...
export const SECTOR_STYLES: Readonly<Record<SectorVisualKind, SectorStrokeToken>> = {
  ...
  'summer-cooling-wind': { color: '#25BFC0', labelColor: '#9EF3EA', width: { minPx: 7, frameRatio: 0.0056 }, dash: [14, 7], fillAlpha: 0.14, lineStyle: 'dashed' },
  'cold-front-wind': { color: '#4D8FE0', labelColor: '#B9D7FF', width: { minPx: 7, frameRatio: 0.0056 }, dash: [14, 7], fillAlpha: 0.14, lineStyle: 'dashed' },
  'berg-wind': { color: '#E08B24', labelColor: '#FFC071', width: { minPx: 7, frameRatio: 0.0056 }, dash: [14, 7], fillAlpha: 0.15, lineStyle: 'dashed' },
  fire: { color: '#E7562D', labelColor: '#FFAA8E', width: { minPx: 3, frameRatio: 0.0038 }, dash: [10, 5], fillAlpha: 0.12, lineStyle: 'dashed' },
  driveway: { color: '#B1B7BD', labelColor: '#E2E6EA', width: { minPx: 3, frameRatio: 0.0036 }, dash: [], fillAlpha: 0, lineStyle: 'solid' },
