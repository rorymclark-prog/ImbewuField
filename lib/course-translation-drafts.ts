...
export const COURSE_TRANSLATION_DRAFTS: Record<string, LocalizedLessonContent> = {
  ...
  "soil-health-l1": {
    ...
    "quiz": [
      ...
      {
        "q": "Umlimi uthola umhlabathi ominyene nemisundu embalwa. Yisiphi isinyathelo esiwusizo esilandelayo?",
        "options": [
  ...
  "soil-health-l3": {
    ...
    "quiz": [
      ...
      {
        "q": "Yini okufanele uyikhumbule ngoketshezi oluphuma emgqonyeni wemisundu?",
        "options": [
