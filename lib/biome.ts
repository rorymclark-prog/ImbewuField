...
export const BIOMES: Record<string, SABiome> = {
  SAVANNA: {
    ...
    keySpecies: ['Marula', 'Mopane', 'Wild Fig', 'Leadwood', 'Fever Tree', 'Buffalo Thorn'],
  ...
  FYNBOS: {
    ...
    challenges: ['Fire-cycle dependency (burns every 10–15 years)', 'Listed invasive alien plants', 'No edible indigenous Fynbos food plants — zone 1–2 must import soil', 'Dry hot summer'],
  },
  SUCCULENT_KAROO: {
  ...
  ALBANY_THICKET: {
    ...
    keySpecies: ['Spekboom', 'Wild Plum', 'Waterberry', 'Noors'],
    ...
    challenges: ['Severe degradation from goat overgrazing', 'Dense thorny vegetation', 'Listed invasive cactus requiring control', 'Limited water in dry season'],
  },
  IOCB: {
  ...
  FOREST: {
    ...
    challenges: ['Limited sunlight under dense canopy', 'Legally protected (cannot clear forest)', 'Listed invasive alien plants', 'Slug and snail pressure'],
  },
  OUTSIDE: {
