...
export const ELEMENT_CATALOG: DesignElementDef[] = [
  ...
  },
  {
    ...
    name: 'Banana Circle',
    icon: '🍌',
    art: '/element-art/banana_circle.png',
    shape: 'circle',
    wM: 3.5,
    hM: 3.5,
    color: '#A9743F',
  ...
  },
  {
    ...
    name: 'Citrus Tree',
    icon: '🍊',
    art: '/element-art/tree_citrus.png',
    shape: 'circle',
    wM: 4,
    hM: 4,
    color: '#4E8B3B',
  ...
  },
  {
    ...
    name: 'Mango Tree',
    icon: '🥭',
    art: '/element-art/tree_mango.png',
    shape: 'circle',
    wM: 10,
    hM: 10,
    color: '#4E8B3B',
  ...
  },
  {
    ...
    name: 'Avocado Tree',
    icon: '🥑',
    art: '/element-art/tree_avocado.png',
    shape: 'circle',
    wM: 8,
    hM: 8,
    color: '#4E8B3B',
  ...
  },
  {
    ...
    name: 'Macadamia Tree',
    icon: '🌰',
    art: '/element-art/tree_macadamia.png',
    shape: 'circle',
    wM: 9,
    hM: 9,
    color: '#4E8B3B',
  ...
  },
  {
    ...
    name: 'Litchi Tree',
    icon: '🍒',
    art: '/element-art/tree_litchi.png',
    shape: 'circle',
    wM: 8,
    hM: 8,
    color: '#4E8B3B',
  ...
  },
  {
    ...
    name: 'Pawpaw Tree',
    icon: '🌴',
    art: '/element-art/tree_pawpaw.png',
    shape: 'circle',
    wM: 2.5,
    hM: 2.5,
    color: '#4E8B3B',
  ...
  },
  {
    ...
    name: 'Natal Plum',
    icon: '🫐',
    art: '/element-art/tree_natal_plum.png',
    shape: 'circle',
    wM: 3,
    hM: 3,
    color: '#4E8B3B',
  ...
  },
  {
    ...
    name: 'Wild Plum',
    icon: '🍇',
    art: '/element-art/tree_wild_plum.png',
    shape: 'circle',
    wM: 7,
    hM: 7,
    color: '#4E8B3B',
  ...
  },
  {
    ...
    name: 'Waterberry',
    icon: '💠',
    art: '/element-art/tree_waterberry.png',
    shape: 'circle',
    wM: 8,
    hM: 8,
    color: '#4E8B3B',
  ...
  },
  {
    ...
    icon: '🟡',
    art: '/element-art/tree_marula.png',
    shape: 'circle',
    wM: 12,
    hM: 12,
    color: '#4E8B3B',
  ...
  },
  {
    ...
    name: 'Kei Apple',
    icon: '🟠',
    art: '/element-art/tree_kei_apple.png',
    shape: 'circle',
    wM: 4,
    hM: 4,
    color: '#4E8B3B',
  ...
  },
  {
    ...
    name: 'Banana Clump',
    icon: '🍃',
    art: '/element-art/banana_clump.png',
    shape: 'circle',
    wM: 3,
    hM: 3,
    color: '#4E8B3B',
  ...
  // in TREE_CLIMATES below.
  {
    ...
    name: 'Apple Tree',
    icon: '🍎',
    art: '/element-art/tree_apple.png',
    shape: 'circle',
    wM: 4,
    hM: 4,
    color: '#4E8B3B',
  ...
  },
  {
    ...
    name: 'Pomegranate',
    icon: '🔴',
    art: '/element-art/tree_pomegranate.png',
    shape: 'circle',
    wM: 3,
    hM: 3,
    color: '#4E8B3B',
  ...
  },
  {
    ...
    name: 'Olive Tree',
    icon: '🫒',
    art: '/element-art/tree_olive.png',
    shape: 'circle',
    wM: 6,
    hM: 6,
    color: '#4E8B3B',
