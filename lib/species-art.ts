...
export const SPECIES_ART = {
  ...
  'ceratonia-siliqua': { picker: null, plan: 'carob-tree-v1.png' },
  ...
  'osteospermum-moniliferum': { picker: null, plan: 'bietou-v1.png' },
  'grewia-flava': { picker: null, plan: 'brandybush-v1.png' },
