...
export default function WorkedDesignPage() {
  return <div className={styles.page}>
    <header className={styles.header}><MenuButton /><BackButton fallback="/student/design" /><OfflinePageLink href="/student/design"><DesignDraftCopy en="Design a homestead" zu="Dizayina ikhaya" /></OfflinePageLink><span data-header-secondary><DesignDraftCopy en="Worked demonstration" zu="Ukuboniswa komsebenzi oqediwe" /></span></header>
