...
export default function DesignScalePage() {
  ...
  return <div className={styles.page}>
    <header className={styles.header}><MenuButton /><BackButton fallback="/student/design/d4-1" /><Link href="/student/design">Design a homestead</Link><span>Scale practice</span></header>
