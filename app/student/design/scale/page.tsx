...
export default function DesignScalePage() {
  ...
  return <div className={styles.page}>
    <header className={styles.header}><MenuButton /><BackButton fallback="/student/design/d4-1" /><OfflinePageLink href="/student/design"><DesignDraftCopy en="Design a homestead" zu="Dizayina ikhaya" /></OfflinePageLink><span data-header-secondary><DesignDraftCopy en="Scale practice" zu="Ukuzilolonga ngesikali" /></span></header>
