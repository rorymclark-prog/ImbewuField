...
export default function DesignFolderPage() {
  return <div className={styles.page}>
    <header className={styles.header}><MenuButton /><BackButton fallback="/student/design" /><Link href="/student/design">Design a homestead</Link><span>Your learning folder</span></header>
