...
export default function DesignCasePage() {
  ...
  return <div className={styles.page}>
    <header className={styles.header}><MenuButton /><BackButton fallback="/student/design" /><OfflinePageLink href="/student/design">Design a homestead</OfflinePageLink><span>The busy yard</span></header>
    <main className={styles.main}>
      ...
      <DesignCasePractice />
      <section className={styles.section}><h2>Apply the same questions to your own folder</h2><p>Keep observed, reported, measured and proposed information distinct. Ask your learning partner to trace a decision from the brief to its source. This early case deliberately remains unmeasured; use the separate fictional worked demonstration to practise a supplied model and a later revision.</p><div className={styles.actions}><OfflinePageLink className={styles.primary} href="/student/design/worked">Open the worked demonstration →</OfflinePageLink><OfflinePageLink href="/student/design/d1-1">Begin with the household brief →</OfflinePageLink><OfflinePageLink href="/student/design">Return to all eighteen lessons</OfflinePageLink></div></section>
    </main>
  </div>;
}
