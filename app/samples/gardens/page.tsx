...
export default function SampleGardensPage() {
  ...
  return <main className={styles.page}><div className={styles.wrap}>
    ...
    <h1>{SAMPLE_GARDENS.length} gardens</h1><p>Choose a garden to see its layout, people and example report. These are fictional examples; opening them does not change your live project.</p>
    {garden&&<section ref={detail} className={styles.card} aria-label="Selected garden">
      ...
      <h2 style={{marginTop:24}}>Example participants</h2><p>Fictional adults · {garden.language}-speaking group. Portraits may repeat across examples.</p>
      ...
      <div className={styles.actions}><a href={sampleGardenReportUrl(garden.id)} target="_blank" rel="noreferrer">Open completed report (PDF)</a><a href={sampleGardenReportUrl(garden.id)} download={`${garden.id}-sample-report.pdf`}>Download report</a></div>
