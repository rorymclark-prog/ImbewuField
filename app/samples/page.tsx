...
export default function SamplesPage() {
  ...
  return <main className={styles.root} style={{ height: '100dvh', minHeight: 0, overflowY: 'auto', paddingBottom: 'calc(var(--bottom-nav-height, 64px) + 24px + env(safe-area-inset-bottom, 0px))' }}><div className={styles.wrap}>
    ...
    <div className={styles.hero} style={{ marginTop: 16, padding:20 }}><span>IMBEWUFIELD · EXPLORE</span><h1>Choose a view</h1><p>Demo the app without changing a real project. Use the Sample badge in the menu to return here.</p></div>
    <p className={styles.notice}>All programme results and people are fictional. The farmer example uses the saved Ubhejane design. These are demonstrations, not verified project deliverables.</p>
    ...
    <button type="button" onClick={() => { if (enterSampleMode()) window.location.reload(); }}>Reset practice records</button>
