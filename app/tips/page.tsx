...
export default function TipsPage() {
  ...
  return <main className={styles.page}><div className={styles.wrap}>
    ...
    {lang === 'zu' && <p role="note" style={{ margin: '16px 0 0', fontSize: 12 }}><span lang="zu">{translate('zu', 'designStudioZuluDraftBadge')}</span> — <span lang="en">Unreviewed isiZulu draft for the translated page labels. English guidance remains visible below.</span></p>}
