...
test('the cache key matches the app-wide imbewu_loc_v6 format at 5 dp', () => {
  ...
  assert.equal(locationDataCacheKey(-27.726231, 31.963044), 'imbewu_loc_v6_-27.72623_31.96304');
});
