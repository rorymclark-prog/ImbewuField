...
// CLAUDE.md: ochre is a FILL, not text — as text it is 2.54:1 on paper. /login (and the since-deleted
// /gate) painted their error copy with var(--color-ochre-light) anyway; --gold-dim is the token declared for
...
const FILES = ['../app/login/page.tsx'];
