# Soil Health & Composting L1 — complete isiZulu review draft
...
- Slide 5 accompanies the current two-example still. Do not describe the held video as learner media or imply the still proves soil health.
- No fixed jar proportions, soap substitute, settling time, treatment recipe, new crop species or causal diagnosis is authorized here.
...
1. Use several clues to assess soil condition.
2. Soil colour and worm counts alone do not diagnose the cause of a problem.
3. A jar exercise gives a rough indication of texture, not a complete soil test.
4. Check drainage, roots and management history before choosing a remedy.

### Proposed isiZulu

1. Sebenzisa izimpawu eziningana ukuze uhlole isimo somhlabathi.
2. Umbala womhlabathi nokubala izibungu kukodwa akuchazi imbangela yenkinga.
3. Ukuhlola ngebhodlela kunikeza umbono oseduze kuphela wokuthungwa komhlabathi; akusikho ukuhlolwa komhlabathi okuphelele.
4. Hlola ukuphuma kwamanzi, izimpande nomlando wokunakekela ngaphambi kokukhetha ikhambi.

## Quiz

Correct answer positions match the current English source: Question 1 correct option B (index 1); Question 2 correct option C (index 2). Keep every option and rationale aligned.

### Question 1 — cloudy jar water

**English question:** A soil jar still has cloudy water above the sand layer. What should the farmer conclude?

**Proposed isiZulu question:** Amanzi asengamafu ebhodleleni lomhlabathi, ngaphezu kongqimba lwesihlabathi. Yisiphi isiphetho okufanele umlimi asenze?

| Option | English | Proposed isiZulu |
| --- | --- | --- |
| A | The soil definitely needs less water | Umhlabathi nakanjani udinga amanzi amancane |
| B — correct | Fine particles may still be suspended; more observation is needed | Izinhlayiya ezincane kungenzeka zisantanta; kudingeka kuqhubeke ukubukwa |
| C | All the clay has already settled | Lonke ubumba seluhleli phansi kakade |
| D | The crop definitely needs gypsum | Isitshalo nakanjani sidinga i-gypsum |

**English rationale:** Cloudy water can contain unsettled fine particles. One early observation cannot establish the final proportions or the right treatment.

**Proposed isiZulu rationale:** Amanzi afiphele angase abe nezinhlayiya ezincane ezingakahlali phansi. Ukubheka kanye nje kusenesikhathi akukwazi ukukhombisa izilinganiso zokugcina noma indlela efanele yokwelapha.

### Question 2 — compacted soil and few worms

**English question:** A farmer finds compacted soil and few worms. What is the useful next step?

**Proposed isiZulu question:** Umlimi uthola umhlabathi ominyene nezibungu ezimbalwa. Yisiphi isinyathelo esiwusizo esilandelayo?

| Option | English | Proposed isiZulu |
| --- | --- | --- |
| A | Assume every soil organism has died | Cabanga ukuthi zonke izinto eziphilayo ezisemhlabathini zifile |
| B | Add a treatment without checking the site | Faka ikhambi ngaphandle kokuhlola indawo |
| C — correct | Check drainage, roots, moisture and management history | Hlola ukuphuma kwamanzi, izimpande, umswakama nomlando wokunakekela |
| D | Give up because the soil cannot improve | Yeka ukuzama ngoba umhlabathi awukwazi ukuba ngcono |

**English rationale:** Several observations help identify a problem. Worm activity varies with conditions, so few worms alone do not establish its cause.

**Proposed isiZulu rationale:** Ukubheka izinto eziningana kusiza ukuthola ukuthi inkinga ingaba yini. Umsebenzi wezibungu uyashintsha kuye ngezimo, ngakho izibungu ezimbalwa zodwa azichazi imbangela yenkinga.

## Narration — exact L1 range: slides 1–8

### Slide 1 — Soil Health & Composting
...
Kule modyuli, funda ukubheka nokufunda umhlabathi, ukwenza i-compost ephephile, ukuvikela umhlabathi ongenalutho, nokusebenzisa izitshalo zokumboza umhlabathi nama-worm farm.
...
Nakekela inqwaba ye-compost, vikela umhlabathi ongenalutho, futhi uhlukanise ama-worm castings noketshezi oluphuma emgqonyeni wezibungu.
...
1. Is `indlela efanele` in slide 1 clear without sounding like a sanitation guarantee? The English overview says “make safe compost”; the main L1 lesson does not validate sanitation.
2. Are borrowed terms such as `i-compost`, `ama-worm farm`, `i-silt`, `i-mulch` and “jar” natural and understood aloud? Is there a familiar term for suitable dispersing detergent that does not imply dish soap specifically?
3. Does the jar wording preserve that this is a rough exercise, that clumps and unsettled clay mislead, and that accurate texture needs a soil laboratory? Does any sentence suggest a fixed amount or waiting time?
4. Do “may/can,” “does not prove,” and “alone” remain clear in the soil diagnosis and quiz? Does the wording avoid diagnosing chemical damage from pale colour or few worms?
5. Does slide 5 describe the two-example still without claiming the still proves health or referring to held video?
6. Are worm castings and liquid drainage clearly distinguished without suggesting how to use liquid drainage?
7. Confirm answer B for Quiz 1 and C for Quiz 2, and make sure the distractors remain clearly incorrect in ordinary spoken isiZulu.
8. Record reviewer name/role, language and farming experience, date, exact edits and what was approved.

## Source and safety holds

- No recipe proportions, soap substitution, settling timetable, watering instruction or soil treatment is added.
- Soil colour, worm counts, smell or channels alone do not establish the cause of a problem.
- This packet does not promise that any compost is sanitized. Later compost material's hot-centre and pathogen cautions remain in force.
- The draft stays review-only until first-language review is recorded. No learner app content, quiz source, audio, media or manifest is changed here.
