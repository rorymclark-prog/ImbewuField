...
| Water Harvesting L1–L4 | [L1](water-harvesting-l1.zu.review.md), [L2](water-harvesting-l2.zu.review.md), [L3](water-harvesting-l3.zu.review.md), [L4](water-harvesting-l4.zu.review.md); [L1–L3 full drafts and handoff](WATER-HARVESTING-ISIZULU-FULL-DRAFT-HANDOFF.md) | Qualified earthwork and roof-water limits; stale first-flush numbers; L4 greywater source/use needs local sanitation and municipal reconciliation before translation or recording. |
