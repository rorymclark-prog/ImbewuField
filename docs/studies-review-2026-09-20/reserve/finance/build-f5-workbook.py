...
para('The app has paid-in-full/unpaid status only. Keep part payments, adjustments and credits in a separate checked supporting schedule. App guide: imbewufield.vercel.app/student/guides/sales',small);page()
