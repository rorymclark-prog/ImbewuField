...
| Existing painted archetype | `tree_citrus`, `tree_mango`, `tree_avocado`, `tree_macadamia`, `tree_guava`, `tree_litchi`, `tree_moringa`, `tree_indigenous`, `tree_apple`, `tree_pear`, `tree_plum`, `tree_peach`, `tree_fig`, `tree_pomegranate`, `tree_olive` | `orchard-canopy-v1.png` |
