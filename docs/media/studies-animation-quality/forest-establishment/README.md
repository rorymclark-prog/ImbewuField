...
Local verification: typecheck clean; full test suite passes with zero failures and one existing shape-sync TODO; whitespace check clean. Browser preview and production checks are recorded in issue #35 after release.
