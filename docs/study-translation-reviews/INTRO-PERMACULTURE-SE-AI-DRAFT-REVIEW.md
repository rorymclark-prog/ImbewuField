# Introduction to Permaculture — Sesotho draft review packet
...
- Lesson 1: the three ethics, “Fair Share”, surplus, composting and seed-saving examples; the shared borehole conditions (permission, source capacity and monitoring).
- Lesson 2: attribution of the twelve design principles; observing through the source’s stated period; hail impacts; safe overflow route and trained local advice before digging; fresh manure precautions before edible crops return.
- Lesson 3: the source’s Zone 0–5 examples, visit frequencies and windbreak placement based on observed wind direction.
- Check Sesotho grammar, terms, reading level and regional fit throughout. Keep all source facts, conditions, figures and species unchanged.
...
**Sesotho AI draft infographic alt text:**
...
### Quiz question 2 — source answer index `2` (unchanged)
...
## Lesson 2: `intro-permaculture-l2`
...
### Quiz question 1 — source answer index `1` (unchanged)
...
### Quiz question 2 — source answer index `1` (unchanged)
