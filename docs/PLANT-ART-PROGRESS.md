...
- Current result: 57 PASS, 37 FAIL, 12 MISSING
...
| Waterblommetjie | PASS | `public/element-art/tree_waterblommetjie.png` | `c1f4f37` | FAIL | `public/render-assets/reference-blueprint/waterblommetjie-v1.png` | `b93e78d` |
| Wild date palm | PASS | `public/element-art/tree_wild_date_palm.png` | `b93e78d` | FAIL | `public/render-assets/reference-blueprint/wild-date-palm-v1.png` | `b93e78d` |
| Wild medlar / mmilo | PASS | `public/element-art/tree_wild_medlar_mmilo.png` | `b93e78d` | FAIL | `public/render-assets/reference-blueprint/wild-medlar-v1.png` | `b93e78d` |
| Bietou / bush-tick berry | FAIL | `public/element-art/tree_bietou.png` | `7533e37` | FAIL | `public/render-assets/reference-blueprint/bietou-v1.png` | `b93e78d` |
...
| Buffalo thorn | PASS | `public/element-art/tree_buffalo_thorn.png` | `d21827f` | FAIL | `public/render-assets/reference-blueprint/buffalo-thorn-v1.png` | `213ab1d` |
| Karoo boer-bean | PASS | `public/element-art/tree_karoo_boer_bean.png` | `018d9e2` | FAIL | `public/render-assets/reference-blueprint/karoo-boer-bean-v1.png` | `213ab1d` |
| Pigeonwood / umbengele | PASS | `public/element-art/tree_pigeonwood.png` | `018d9e2` | FAIL | `public/render-assets/reference-blueprint/pigeonwood-v1.png` | `213ab1d` |
| Powder-puff tree / iBoqo | PASS | `public/element-art/tree_powder_puff_tree.png` | `1ecd8f2` | FAIL | `public/render-assets/reference-blueprint/powder-puff-tree-v1.png` | `213ab1d` |
| Karee | PASS | `public/element-art/tree_karee.png` | `d21827f` | FAIL | `public/render-assets/reference-blueprint/karee-v1.png` | `81e0528` |
| White milkwood | PASS | `public/element-art/tree_white_milkwood.png` | `1ecd8f2` | FAIL | `public/render-assets/reference-blueprint/white-milkwood-v1.png` | `81e0528` |
| Olive | PASS | `public/element-art/tree_olive.png` | `018d9e2` | FAIL | `public/render-assets/reference-blueprint/olive-v1.png` | `81e0528` |
