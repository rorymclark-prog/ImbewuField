...
- Current result: 102 PASS, 0 FAIL, 4 MISSING
...
| Honey-thorn / kriedoring | PASS | `public/element-art/tree_honey_thorn.png` | `5337360` | MISSING | `public/render-assets/reference-blueprint/honey-thorn-v1.png` | `—` |
