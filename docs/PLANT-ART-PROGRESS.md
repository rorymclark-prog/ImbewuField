...
- Current result: 60 PASS, 34 FAIL, 12 MISSING
...
| Bietou / bush-tick berry | PASS | `public/element-art/tree_bietou.png` | `017067c` | FAIL | `public/render-assets/reference-blueprint/bietou-v1.png` | `b93e78d` |
