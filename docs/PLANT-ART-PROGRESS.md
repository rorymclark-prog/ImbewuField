...
- Current result: 84 PASS, 10 FAIL, 12 MISSING
...
| Bluebush | MISSING | `public/element-art/tree_bluebush.png` | `—` | PASS | `public/render-assets/reference-blueprint/bluebush-v1.png` | `8489f3e` |
...
| Gariep ebony | PASS | `public/element-art/tree_gariep_ebony.png` | `b93e78d` | PASS | `public/render-assets/reference-blueprint/gariep-ebony-tree-v1.png` | `0cd1d72` |
