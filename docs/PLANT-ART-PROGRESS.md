...
- Current result: 100 PASS, 0 FAIL, 6 MISSING
...
| Cape boxthorn / kriedoring | PASS | `public/element-art/tree_cape_boxthorn.png` | `df1b4ac` | MISSING | `public/render-assets/reference-blueprint/cape-boxthorn-v1.png` | `—` |
