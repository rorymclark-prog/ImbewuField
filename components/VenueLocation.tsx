...
export default function VenueLocation({ latitude, longitude, sample, venue = '', onChange }: {
  ...
  function locate() {
    ...
    if (sample) {
      ...
      setMessage('Venue location added. Save the session to keep it.');
      return;
    }
  ...
  return <section style={{ padding: 16, marginBlock: 16, border: '1px solid #b4c6b6', borderRadius: 16, background: '#f3f7f1' }}>
    <h3>Venue & directions</h3><p>At the venue? Tap GPS to add the location to this session.</p>
