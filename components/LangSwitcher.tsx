...
export default function LangSwitcher() {
  ...
  return (
    <div className="flex items-center gap-1.5 px-3.5 rounded-full flex-shrink-0"
      style={{ background: 'rgba(22,37,20,0.6)', border: '1px solid var(--border)', minHeight: 44 }}>
      ...
      <select
        ...
        style={{ background: 'transparent', color: 'var(--text-secondary)', border: 'none', fontSize: 15 }}
      >
        {APP_LANGS.map((l) => (
