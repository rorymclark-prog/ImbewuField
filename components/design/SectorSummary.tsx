...
// (imbewu_loc_v5_{lat}_{lon}, keyed off the ?lat/?lon URL params). If nothing is cached it degrades
...
function resolveSectorContext(): { lat: number; lon: number; site: SectorSite | null } | null {
  ...
  try {
    ...
    const raw = localStorage.getItem(`imbewu_loc_v5_${lat.toFixed(5)}_${lon.toFixed(5)}`);
