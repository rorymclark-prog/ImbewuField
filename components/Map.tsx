    ...
    <div className="relative w-full h-full">
        ...
        <>
          ...
          <div className="fixed left-1/2 -translate-x-1/2 flex items-stretch gap-2"
            ...
            <button
              ...
              <span style={{ fontSize: 13.5, marginTop: 3 }}>{cancelArmed ? 'Discard?' : 'Cancel'}</span>
            </button>
            ...
            <button onClick={undoPin} disabled={draftPoints.length === 0}
              ...
              <span style={{ fontSize: 18, lineHeight: 1 }}>↶</span>
              <span style={{ fontSize: 13.5, marginTop: 3 }}>Undo</span>
            </button>
            ...
            <button onClick={finishPinDraw} disabled={draftPoints.length < 3}
              ...
              <span style={{ fontSize: 18, lineHeight: 1 }}>✓</span>
              <span style={{ fontSize: 13.5, marginTop: 3 }}>Finish</span>
            </button>
          </div>
        </>
      )}
        ...
        <>
          ...
          <div className="fixed left-1/2 -translate-x-1/2 flex items-stretch gap-2"
            ...
            <button onClick={cancelReticleEdit}
              ...
              <span style={{ fontSize: 18, lineHeight: 1 }}>✗</span>
              <span style={{ fontSize: 13.5, marginTop: 3 }}>Cancel</span>
            </button>
            <button onClick={removeEditCorner} disabled={selCorner == null || editPoints.length <= 3}
              ...
              <span style={{ fontSize: 18, lineHeight: 1 }}>🗑</span>
              <span style={{ fontSize: 13.5, marginTop: 3 }}>Remove</span>
            </button>
            ...
            <button onClick={finishReticleEdit}
              ...
              <span style={{ fontSize: 18, lineHeight: 1 }}>✓</span>
              <span style={{ fontSize: 13.5, marginTop: 3 }}>Done</span>
            </button>
          </div>
        </>
      )}
      ...
      */}
      ...
      >
        ...
        {layersOpen && (
          <div>
            <div style={{ fontSize: 13, fontFamily: 'var(--font-mono)', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'rgba(140,192,100,0.6)', marginBottom: 5 }}>
              Edit tool (try both)
            </div>
